...
test.describe('Asteroids Game', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/games/asteroids/asteroids.html');
  });
  ...
  //       await expect(page.locator('#thrustBtn')).toBeVisible();
  //     }
  //   }
  // });
  ...
  //   // This is not guaranteed to hit an asteroid, so this assertion might be flaky.
  ...
  //       expect(payload.game).toBe('asteroids');
  //     }
